  ...
  options =
    ...
    with types;
    {
      services.comin = {
        ...
        sshKnownHostsPath = mkOption {
          type = nullOr path;
          default = null;
          description = ''
            Path to the SSH known_hosts file. This is required for SSH remotes
        ...
        sshKeyPath = mkOption {
          ...
          description = ''
            ...
            When set, this key will be used for all SSH operations (git fetch, submodule updates, nix flake fetch).
          '';
        };
        exporter = mkOption {
